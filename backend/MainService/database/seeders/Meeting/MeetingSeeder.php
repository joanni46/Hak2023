...
class MeetingSeeder extends Seeder
{
    public function run(): void
    {
        Meeting::query()->create([
            ...
            'specialist_id' => User::query()->where((new User())->getTable() . '.email', '=', 'irina@gmail.com')->firstOrFail()->id,
        ...
        Meeting::query()->create([
            ...
            'specialist_id' => User::query()->where((new User())->getTable() . '.email', '=', 'elena@gmail.com')->firstOrFail()->id,
        ...
        Meeting::query()->create([
            ...
            'specialist_id' => User::query()->where((new User())->getTable() . '.email', '=', 'oleg@gmail.com')->firstOrFail()->id,
